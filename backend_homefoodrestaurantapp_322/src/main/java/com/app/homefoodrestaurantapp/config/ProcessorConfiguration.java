package com.app.homefoodrestaurantapp.config;
...
import com.app.homefoodrestaurantapp.nameBuilder.APINameBuilder;
...
public class ProcessorConfiguration {
  ...
  public JPAODataSessionContextAccess sessionContext(@Autowired final EntityManagerFactory emf) throws ODataException {
    ...
    return JPAODataServiceContext.with()
        ...
        .setRequestMappingPath("homefoodrestaurantapp")
        .build();
  }
